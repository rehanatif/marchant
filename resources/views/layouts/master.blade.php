...
<head> 
    ...
    <!-- THEME INTEGRATIONS -->
    <!-- Favicon icon -->
    <link rel="icon" href="{{$path}}libraries\assets\images\favicon.ico" type="image/x-icon">
    <!-- Google font-->
                ...
                <nav class="pcoded-navbar">
                    <div class="pcoded-inner-navbar">
                        <ul class="pcoded-item pcoded-left-item">
                            <li class="pcoded-hasmenu {{UH::getSegment(['customers'],'active-li')}} no-after"  >
                                <a href="{{url('home')}}" >
                            ...
                            <li class="pcoded-hasmenu no-after">
                                <a href="{{url('/branch')}}">
                                    <span class="pcoded-micon"><i class="feather icon-home"></i></span>
                                    <span class="pcoded-mtext">GIS Map</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>

                                
                            </li>
                            <li class="pcoded-hasmenu {{UH::getSegment(['users','usertypes'],'active-li')}}" >
                                ...
                                <ul class="pcoded-submenu">
                                    ...
                                    <li class=" {{UH::getSegment(['customers'],'pcoded-trigger')}}">
                                        <a href="{{url('usertypes')}}" data-i18n="nav.sticky-notes.main">
                                            <span class="pcoded-micon"><i class="ti-layers-alt"></i></span>
                                            <span class="pcoded-mtext">User Types</span>
                                            {{-- <span class="pcoded-badge label label-danger">HOT</span> --}}
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                    </li>

                                    <li class=" {{UH::getSegment(['roles'],'pcoded-trigger')}}">
                                        <a href="{{url('roles')}}" data-i18n="nav.sticky-notes.main">
                                            <span class="pcoded-micon"><i class="ti-layers-alt"></i></span>
                                ...
                                <ul class="pcoded-submenu">
                                    <li class="">
                                        <a href="javascript:void(0)" data-i18n="nav.form-components.main">
                                            ...
                                            <span class="pcoded-mtext">Manange Bookings</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                    ...
                                    <li class=" ">
                                        <a href="form-picker.htm" data-i18n="nav.form-pickers.main">
                                            ...
                                            <span class="pcoded-mtext">Archeive Bookings</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                    </li>
                                    ...
                                    <li class=" ">
                                        <a href="form-select.htm" data-i18n="nav.form-select.main">
                                            ...
                                            <span class="pcoded-mtext">Soft Bookings</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                    </li>
                                    <li class=" ">
                                    ...
                                    <li class=" ">
                                        <a href="form-wizard.htm" data-i18n="nav.form-wizard.main">
                                            ...
                                            <span class="pcoded-mtext">Transfer Bookings</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                    </li>
                                    <li class="">
                                        <a href="javascript:void(0)" data-i18n="nav.ready-to-use.main">
                                            ...
                                            <span class="pcoded-mtext">Block Bookings</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                     ...
                                     <li class="">
                                        <a href="javascript:void(0)" data-i18n="nav.ready-to-use.main">
                                            <span class="pcoded-micon"><i class="ti-receipt"></i></span>
                                            <span class="pcoded-mtext">Resale Bookings</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                     ...
                                     <li class="">
                                        <a href="javascript:void(0)" data-i18n="nav.ready-to-use.main">
                                            <span class="pcoded-micon"><i class="ti-receipt"></i></span>
                                            <span class="pcoded-mtext">Hot Bokings</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
